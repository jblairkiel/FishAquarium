...
class Inspector():
    ...
    def drawPane(self, screen, gameWidth, gameHeight, mosX, mosY):
        ...
        if (self.currentItem != None):
            #Draw Pane
            pg.draw.rect(screen, (40, 40, 40), pg.Rect(gameWidth - 300, 0, 300, gameHeight))
            ...
            if self.currentItem != None:
                #Draw Fish at top
                pg.draw.rect(screen, self.currentItem.color, pg.Rect(gameWidth - 150, drawingYIter, self.currentItem.lenX, self.currentItem.lenY))
